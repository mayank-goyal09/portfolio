// ============================================
// 🔮 DEEP LEARNING PLASMA SPHERE BACKGROUND
// Three.js Plasma Orb with Noise
// ============================================
...
(function () {
    ...
    function init() {
        const container = document.getElementById('plasmaContainer');
        if (!container || typeof THREE === 'undefined') {
            console.warn('Plasma: Container not found or Three.js not loaded');
            return;
        }

        // Configuration (Updated with your preferred settings)
        const params = {
            timeScale: 0.78,
            rotationSpeedX: 0.002,
            rotationSpeedY: 0.005,
            plasmaScale: 0.1737,       // Texture Scale
            plasmaBrightness: 1.31,    // Brightness
            voidThreshold: 0.072,      // Voids
            // Colors
            colorDeep: 0x003324,       // Dark teal/green
            colorMid: 0xff0095,        // Pink/Magenta
            colorBright: 0x00ffe1,     // Cyan
            shellColor: 0x9900ff,      // Purple edge
            shellOpacity: 0.591        // Edge opacity
        };

        // Scene (transparent background to show stars behind)
        const scene = new THREE.Scene();
        // No background color - let CSS stars show through
        ...
        animate();
        console.log('🔮 Plasma Sphere initialized successfully!');
    }
})();
